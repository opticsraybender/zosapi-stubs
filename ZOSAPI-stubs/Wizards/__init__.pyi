...
class CriterionTypes(IntEnum):
    """ZOSAPI.Wizards.CriterionTypes"""
    Wavefront = 0
    Contrast = 1
    Spot = 2
    Angular = 3

class DefaultAndDegrees(IntEnum):
    """ZOSAPI.Wizards.DefaultAndDegrees"""
    Default = 0
    Degrees = 1

class DefaultAndFringes(IntEnum):
    """ZOSAPI.Wizards.DefaultAndFringes"""
    Default = 0
    Fringes = 1
    Percent = 2

class IImageData:
    """ZOSAPI.Wizards.IImageData"""
    @property
    ...
    def GetPixelsSafe(self, totalSize: int, height: int, width: int) -> List[int]: ...
    def GetRawData(self) -> List[int]: ...
    def GetRawDataSafe(self, totalSize: int, height: int, width: int) -> List[int]: ...

class INSCBitmapWizard(INSCWizard, IWizard):
    """ZOSAPI.Wizards.INSCBitmapWizard

    Interface for the Merit Function, Nonsequential Component Bitmap Wizard These settings can be retrieved from the IMeritFunctionEditor interface.
    """
    @property
...
class INSCOptimizationWizard(INSCWizard, IWizard):
    """ZOSAPI.Wizards.INSCOptimizationWizard

    Interface for the Merit Function, Nonsequential Component Optimization Wizard. These settings can be retrieved from the IMeritFunctionEditor interface.
    """
    @property
    def NSCSettings(self) -> INSCWizard: ...
    @property
...
class INSCRoadwayLightingWizard(IWizard):
    """ZOSAPI.Wizards.INSCRoadwayLightingWizard

    Interface for the Merit Function, Nonsequential Component Roadway Lighting Wizard These settings can be retrieved from the IMeritFunctionEditor interface.
    """
    @property
    def CommonSettings(self) -> IWizard: ...
    @property
...
class INSCToleranceWizard(IToleranceWizard, IWizard):
    """ZOSAPI.Wizards.INSCToleranceWizard

    Interface for the Tolerance Editor, Nonsequential Component Wizard These settings can be retrieved from the IToleranceDataEditor interface.
    """
    @property
    def ToleranceSettings(self) -> IToleranceWizard: ...

class INSCWizard(IWizard):
    """ZOSAPI.Wizards.INSCWizard
...
class ISEQOptimizationWizard(IWizard):
    """ZOSAPI.Wizards.ISEQOptimizationWizard

    Interface for the Merit Function, Sequential Optimization Wizard These settings can be retrieved from the IMeritFunctionEditor interface. Note that this wizard is obsolete and you should use ISEQOptimizationWizard2 instead.
    """
    @property
    def CommonSettings(self) -> IWizard: ...
    @property
...
class ISEQOptimizationWizard2(IWizard):
    """ZOSAPI.Wizards.ISEQOptimizationWizard2"""
    @property
    def CommonSettings(self) -> IWizard: ...
    @property
...
class ISEQToleranceWizard(IToleranceWizard, IWizard):
    """ZOSAPI.Wizards.ISEQToleranceWizard

    Interface for the Tolerance Editor, Sequential Wizard These settings can be retrieved from the IToleranceDataEditor interface.
    """
    @property
    def ToleranceSettings(self) -> IToleranceWizard: ...

class IToleranceWizard(IWizard):
    """ZOSAPI.Wizards.IToleranceWizard
    ...
    def SelectTolerancePreset(self, vendor: ToleranceVendor, grade: ToleranceGrade) -> None:
        """Enum parameters:
            vendor -> ZOSAPI.Wizards.ToleranceVendor
            grade -> ZOSAPI.Wizards.ToleranceGrade
        """
        ...

class IWizard:
    """ZOSAPI.Wizards.IWizard

    Base interface for all the Wizards WizardType.MFENSCOptimization: Merit Function, Nonsequential Component, Optimization WizardType.MFENSCBitmap: Merit Function, Nonsequential Component, Bitmap WizardType.MFENSCRoadwayLighting: Merit Function, Nonsequential Component, Roadway Lighting
    """
    @property
...
class OptimizationTypes(IntEnum):
    """ZOSAPI.Wizards.OptimizationTypes"""
    RMS = 0
    PTV = 1

class PupilArmsCount(IntEnum):
    """ZOSAPI.Wizards.PupilArmsCount"""
    Arms_6 = 0
    Arms_8 = 1
    Arms_10 = 2
    Arms_12 = 3
...
class ReferenceTypes(IntEnum):
    """ZOSAPI.Wizards.ReferenceTypes"""
    Centroid = 0
    ChiefRay = 1
    Unreferenced = 2

class ToleranceGrade(IntEnum):
    """ZOSAPI.Wizards.ToleranceGrade"""
    Commercial = 0
    Precision = 1
    HighPrecision = 2
    CellPhoneLens = 3

class ToleranceVendor(IntEnum):
    """ZOSAPI.Wizards.ToleranceVendor"""
    Asphericon = 0
    EdmundOptics = 1
    Generic = 2
    LaCroix = 3
...
class WizardType(IntEnum):
    """ZOSAPI.Wizards.WizardType"""
    NSCOptimization = 0
