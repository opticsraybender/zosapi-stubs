...
class IAS_PhysicalOpticsPropagation(ZOSAPI.Analysis.Settings.IAS_):
    """ZOSAPI.Analysis.PhysicalOptics.IAS_PhysicalOpticsPropagation"""
    @property
    def Wavelength(self) -> ZOSAPI.Analysis.Settings.IAS_Wavelength: ...
    @property
    def Field(self) -> ZOSAPI.Analysis.Settings.IAS_Field: ...
    @property
    def StartSurface(self) -> ZOSAPI.Analysis.Settings.IAS_Surface:
        """The default value 0 represents the Entrance Pupil."""
        ...
    @property
    def EndSurface(self) -> ZOSAPI.Analysis.Settings.IAS_Surface:
    ...
    @property
    def XSampling(self) -> ZOSAPI.Analysis.SampleSizes: ...
    @XSampling.setter
    def XSampling(self, value: ZOSAPI.Analysis.SampleSizes) -> None: ...
    @property
    def YSampling(self) -> ZOSAPI.Analysis.SampleSizes: ...
    @YSampling.setter
    def YSampling(self, value: ZOSAPI.Analysis.SampleSizes) -> None: ...
    @property
...
class POPBeamTypes(IntEnum):
    """ZOSAPI.Analysis.PhysicalOptics.POPBeamTypes"""
    GaussianWaist = 0
    GaussianAngle = 1
    GaussianSizeAngle = 2
    TopHat = 3
...
class POPDataTypes(IntEnum):
    """ZOSAPI.Analysis.PhysicalOptics.POPDataTypes"""
    Irradiance = 0
    EXIrradiance = 1
    EYIrradiance = 2
    Phase = 3
...
class POPFiberPositions(IntEnum):
    """ZOSAPI.Analysis.PhysicalOptics.POPFiberPositions"""
    ChiefRay = 0
    SurfaceVertex = 1

class POPFiberTypes(IntEnum):
    """ZOSAPI.Analysis.PhysicalOptics.POPFiberTypes"""
    GaussianWaist = 0
    GaussianAngle = 1
    GaussianSizeAngle = 2
    TopHat = 3
...
class POPProjectionTypes(IntEnum):
    """ZOSAPI.Analysis.PhysicalOptics.POPProjectionTypes"""
    AlongBeam = 0
    AlongNormal = 1
    AlongLocalZ = 2

class POPScaleTypes(IntEnum):
    """ZOSAPI.Analysis.PhysicalOptics.POPScaleTypes"""
    Linear = 0
    Log_Minus_5 = 1
    Log_Minus_10 = 2
    Log_Minus_15 = 3

class POPShowAsTypes(IntEnum):
    """ZOSAPI.Analysis.PhysicalOptics.POPShowAsTypes"""
    Surface = 0
    Contour = 1
    GrayScale = 2
    InverseGrayScale = 3
...
class POPZoomTypes(IntEnum):
    """ZOSAPI.Analysis.PhysicalOptics.POPZoomTypes"""
    NoZoom = 0
    X2 = 1
    X4 = 2
    X8 = 3
