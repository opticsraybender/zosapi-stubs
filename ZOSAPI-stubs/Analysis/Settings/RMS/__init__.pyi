...
import ZOSAPI.Analysis.Settings.RMS.RMSField
import ZOSAPI.Analysis.Settings.RMS.RMSFieldMap

from . import RMSField as RMSField
from . import RMSFieldMap as RMSFieldMap

class FieldDensities(IntEnum):
    """ZOSAPI.Analysis.Settings.RMS.FieldDensities"""
    FieldDens_5 = 1
    FieldDens_10 = 2
    FieldDens_15 = 3
    FieldDens_20 = 4
...
class FocusDensities(IntEnum):
    """ZOSAPI.Analysis.Settings.RMS.FocusDensities"""
    FocusDens_5 = 1
    FocusDens_10 = 2
    FocusDens_15 = 3
    FocusDens_20 = 4
...
class IAS_RMSField(ZOSAPI.Analysis.Settings.IAS_):
    """ZOSAPI.Analysis.Settings.RMS.IAS_RMSField"""
    @property
    def Wavelength(self) -> ZOSAPI.Analysis.Settings.IAS_Wavelength: ...
    @property
    def Data(self) -> ZOSAPI.Analysis.Settings.RMS.RMSField.DataType: ...
    @Data.setter
    def Data(self, value: ZOSAPI.Analysis.Settings.RMS.RMSField.DataType) -> None: ...
    @property
...
class IAS_RMSFieldMap(ZOSAPI.Analysis.Settings.IAS_):
    """ZOSAPI.Analysis.Settings.RMS.IAS_RMSFieldMap"""
    @property
    ...
    def Wavelength(self) -> ZOSAPI.Analysis.Settings.IAS_Wavelength: ...
    @property
    def Data(self) -> ZOSAPI.Analysis.Settings.RMS.RMSFieldMap.DataType: ...
    @Data.setter
    def Data(self, value: ZOSAPI.Analysis.Settings.RMS.RMSFieldMap.DataType) -> None: ...
    @property
...
class IAS_RMSFocus(ZOSAPI.Analysis.Settings.IAS_):
    """ZOSAPI.Analysis.Settings.RMS.IAS_RMSFocus"""
    @property
    def Wavelength(self) -> ZOSAPI.Analysis.Settings.IAS_Wavelength: ...
    @property
    def RayDensity(self) -> RayDensities: ...
...
class IAS_RMSLambdaDiagram(ZOSAPI.Analysis.Settings.IAS_):
    """ZOSAPI.Analysis.Settings.RMS.IAS_RMSLambdaDiagram"""
    @property
    def Field(self) -> ZOSAPI.Analysis.Settings.IAS_Field: ...
    @property
    def RayDensity(self) -> RayDensities: ...
...
class Method(IntEnum):
    """ZOSAPI.Analysis.Settings.RMS.Method"""
    GaussQuad = 0
    RectArray = 1

class Orientations(IntEnum):
    """ZOSAPI.Analysis.Settings.RMS.Orientations"""
    Plus_Y = 0
    Minus_Y = 1
    Plus_X = 2
    Minus_X = 3

class RayDensities(IntEnum):
    """ZOSAPI.Analysis.Settings.RMS.RayDensities"""
    RayDens_32x32 = 1
    RayDens_64x64 = 2
    RayDens_128x128 = 3
    RayDens_256x256 = 4
...
class ReferTo(IntEnum):
    """ZOSAPI.Analysis.Settings.RMS.ReferTo"""
    ChiefRay = 0
    Centroid = 1

class WaveDensities(IntEnum):
    """ZOSAPI.Analysis.Settings.RMS.WaveDensities"""
    WaveDens_5 = 1
    WaveDens_10 = 2
    WaveDens_15 = 3
    WaveDens_20 = 4
